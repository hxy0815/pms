											...
											<TBODY>
												...
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD>
														<INPUT class=regtxt title=请填写密码 type=password maxLength=16 size=16 name="password" id="pass">
													</TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>验证码：</FONT></TD>
													<TD>
														<INPUT style="width: 85px; vertical-align:middle" class=regtxt placeholder=请填写验证码 maxLength=50 value="" name="code"/>
														<img id="image" style="vertical-align:middle" src="${pageContext.request.contextPath}/code/getCode?time="+<%=new Date()%> />
													</TD>
												</TR>
											</TBODY>
										</TABLE>
